        ...
        if ($result->num_rows > 0) {
            ...
            {  
                echo '<form method="POST" action="" enctype="multipart/form-data"><div class="divstandard">
                    ...
                    <hr>
                    <img id="imgAvatar" src="data:image/jpeg;base64,'.base64_encode($rows['IMAGE'] ).'" class="rounded mx-auto d-block" style="width: 500px;height:300px;margin-bottom: 50px;">
                    </div>
                    <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Nom Produit</label>
                        <input type="text" class="form-control" name="nomProduit" required value="'.$rows["NOM"].'">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <input type="number" min="0" class="form-control" name="qteStock" required value="'.$rows["QTE_MAX"].'">
                    </div>
                    <div class="form-row">
